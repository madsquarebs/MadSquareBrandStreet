...
<head>
	<meta charset="UTF-8">
      ...
      <meta name="description" content="Advertising agencies in chennai, Digital marketing agencies in chennai, Creative advertising agencies in chennai - MadSquare Brand Street">
      <meta name="Keywords" content="Mad square chennai,MadSquare Chennai, Ad agencies in chennai, Advertising agencies chennai, Digital marketing agencies in chennai">
      <title>Career at MadSquare Brand Street chennai | Advertising agencies in chennai - MadSquare Brand Street - Creative Advertising Agency | Digital Marketing Agency| Branding Solutions in Chennai</title>
      ...
      <link rel="shortcut icon" href="img/MS-logo.png">
          ...
          <div id="topbar">
            <div class="line">
               <!-- <div class="s-12 m-6 l-6">
                  <p>Building brands, building future.</p>
               </div> -->
               <div class="s-12 m-6 l-6">
                  <div class="social right">
                     <a target="_blank" href="https://www.facebook.com/madsquarebrandstreet/"><i class="icon-facebook_circle"></i></a> <a><i class="icon-twitter_circle"></i></a> <a target="_blank" href="http://plus.google.com/114863483683159296719"><i class="icon-google_plus_circle"></i></a> <a><i class="icon-instagram_circle"></i></a>
                  </div>
               </div>
            </div>  
         </div>
